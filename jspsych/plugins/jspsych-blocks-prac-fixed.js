/**
 * jspsych-blocks-prac-fixed
 * Nikolas McNeal (modified from Chris Jungerius (modified from Josh de Leeuw))
 *
...
jsPsych.plugins["blocks-prac-fixed"] = (function () {
  var plugin = {};

  plugin.info = {
    name: "blocks-prac-fixed",
    description: "",
    parameters: {
      stimulus_L: {
      ...
      if (trial.choices != jsPsych.NO_KEYS) {
        keyboardListener = jsPsych.pluginAPI.getKeyboardResponse({
          ...
          callback_function: function (info) {
            ...
            response = info;
            display_selection();
            setTimeout(() => end_trial(false), 500); //set to 500
          },
        });
      }
    };
