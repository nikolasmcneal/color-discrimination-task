...
jsPsych.plugins["rainbow"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    new_html += '<canvas id="jspsych-text"  height="' + 150 + '" width="' + 1300 + '"style = "padding: 0; margin: auto; display: block; width = 350px; height = 225px; position: absolute; top: 400; bottom: 0; left: 60px; right: 0; text-align: center;" ></canvas>'
